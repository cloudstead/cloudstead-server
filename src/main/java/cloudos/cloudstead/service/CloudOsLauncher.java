...
@Slf4j
public class CloudOsLauncher
        extends CloudOsLauncherBase<Admin, CloudOs, CloudOsStatus> {
    ...
    @Override protected CsCloud buildCloud() {
        ...
        return cloudConfig.buildHostedCloud(status.getAdmin().getUuid(), name, edition, region);
    }
